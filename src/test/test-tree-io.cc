...
int TestTreeIO::TestWriteEgret() {
    ...
    return CheckEqual(oss_exp.str(), oss_act.str());
}

int TestTreeIO::TestReadJSON() {
    // Use this tree
...
int TestTreeIO::TestRoundtripJSON() {
    // Use this tree
    stringstream strm;
    JSONTreeIO io;
    io.WriteTree(graph_exp, strm);
...
int TestTreeIO::TestRoundtripJSONQuote() {
    // Use this tree
    stringstream strm;
    JSONTreeIO io;
...
int TestTreeIO::TestWriteMosesXML() {
    string tree_str = "(A (B (C x) (D y)) (E z))";
