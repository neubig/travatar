...
public:
    ...
    bool RunTest() {
        ...
        done++; cout << "TestNbest()" << endl; if(TestNbest()) succeeded++; else cout << "FAILED!!!" << endl;
        done++; cout << "TestNbestNode()" << endl; if(TestNbestNode()) succeeded++; else cout << "FAILED!!!" << endl;
        cout << "#### TestTrimmer Finished with "<<succeeded<<"/"<<done<<" tests succeeding ####"<<endl;
        return done == succeeded;
    }

protected:

    shared_ptr<HyperGraph> rule_graph_, binary_graph_; 
