...
TranslationRuleHiero* TestLookupTableFSM::BuildRule(const string & src, const string & trg, const string & feat) {
...
HyperGraph * TestLookupTableFSM::CreateExpectedGraph(bool extra) {
...
bool TestLookupTableFSM::TestBuildRules(LookupTableFSM & lookup, bool extra) {
    string inp = "I eat two hamburgers";
    Sentence c = Dict::ParseWords(inp);
